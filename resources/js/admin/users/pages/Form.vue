        ...
        <div class="card">
          <div class="card-body">
            ...
            <div class="form-group">
              <label>Имя</label>
              <el-input v-model="user.name" placeholder="Имя" size="medium" clearable></el-input>
            </div>
            <div class="form-group row">
              <div class="col-6">
                <label>Email</label>
                <el-input v-model="user.email" placeholder="Email" size="medium" clearable></el-input>
              </div>
              <div class="col-6">
                <label>Телефон</label>
                <el-input v-model="user.phone" placeholder="Телефон" size="medium" clearable></el-input>
              </div>
            </div>
            <div class="form-group">
            ...
            <div class="form-group row">
              <div class="col-6">
                ...
                <el-select
                  v-model="user.connection_type_id"
            ...
            <div class="card-body">
              ...
              <div class="form-group row">
                <div class="col-12">
                  ...
                  <el-select
                    v-model="user.therapy.problem_severity"
                    placeholder="Тяжесть"
                    clearable
                    size="medium"
                  >
              ...
              <div class="form-group">
                ...
                <el-input
                  v-model="user.therapy.concept_vision"
                  placeholder=""
                  type="textarea"
                  resize="none"
                  :rows="8"
  ...
  methods: {
    ...
    async save() {
      ...
      try {
        let response
        if (this.user.id) {
          response = await this.$http.put(`${this.actions.rest}/${this.user.id}`, this.user)
        } else {
          response = await this.$http.post(this.actions.rest, this.user)
        }
        this.$message.success(response.data.message)
        await this.$router.push({name: 'user-index'})
      } catch (e) {
        if (!e.response) {
          throw e
        }
